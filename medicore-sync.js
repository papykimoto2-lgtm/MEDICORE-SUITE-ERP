...
const MEDICORE_SYNC = {
  ...
  STORES: [
    ...
    { store:'rdv',                   label:'Rendez-vous patients (planning)' },
    { store:'rdv_portail',           label:'Demandes RDV (portail patient)' },
    { store:'portail_documents',     label:'Documents portail patient' },
